...
export function ArtifactList({ artifacts, conversationId }: ArtifactListProps) {
  ...
  const sortedArtifacts = useMemo(() => {
    ...
    const others = list.filter(
      (a) => !a.name.endsWith(".md") && !/\.(png|jpe?g|gif|webp|svg)$/i.test(a.name),
    );
    ...
    <>
      <div className="flex items-center justify-between mb-3 border-b border-border/50 pb-2">
        ...
        <select
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml;charset=UTF-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='%238b949e' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3E%3Cpolyline points='6 9 12 15 18 9'%3E%3C/polyline%3E%3C/svg%3E")`,
